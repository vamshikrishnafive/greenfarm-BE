...
class Userdetails {
    static async userById(req, res, next, id) {
    ...
    static async update(req, res) {
        try {
            await User.findOneAndUpdate({ _id: req.profile._id }, { $set: req.body }, { new: true },
                (err, user) => {
                    if (err) {
    ...
    static async addOrderToUserHistory(req, res, next) {
        let history = [];
